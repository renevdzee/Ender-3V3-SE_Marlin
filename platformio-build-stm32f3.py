...
if mcu.startswith("stm32f1") or mcu.startswith("stm32f3"):
...
VARIANT_REMAP = {
    ...
    "genericSTM32F303RE": "generic_stm32f103r"
}
...
def get_linker_script(board, mcu, upload_protocol):
    if upload_protocol == "dfu":
        ...
        elif board.startswith("genericSTM32F303R"):
            return "bootloader.ld"
...
arch = "armv7-m"
if board_name.startswith("genericSTM32F3"):
    arch = "armv7e-m"
